defmodule Scouter.MixProject do
  ...
  defp deps do
    [
      ...
      {:ecto_sql, "~> 3.10"},
      {:ecto_sqlite3,
       git: "https://git.sr.ht/~sbaildon/ecto_sqlite3",
       ref: "1c499d27c65bfcd47c89a06e5f7787571fcb3ae3",
       override: true},
      {:postgrex, ">= 0.0.0"},
      {:phoenix_html, "~> 4.1"},
      ...
      {:typeid_elixir, "~> 1.1"},
      {:ua_inspector,
       git: "https://github.com/elixir-inspector/ua_inspector",
       ref: "b40401edffea4d039420d828bd3dc1f95a932039"},
      {:locus, "~> 2.3"},
      {:ref_inspector, "~> 2.0"},
      {:ex_cldr, "~> 2.37"},
